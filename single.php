...
<div class="wrapper">
    ...
    ?>
                ...
                <p class="works-details-url details-text"> <span>URL:</span><a href="<?php the_field('url'); ?>" alt="サイト"  target="_blank"><?php the_field('url'); ?></a></p>
                <p class="works-details-language details-text"><span>使用言語: </span><?php the_field('language'); ?></p>
                <p class="works-details-period details-text"><span>制作期間: </span><?php the_field('period'); ?></p>
                <p class="works-details-concept details-text"><span>コンセプト:</span> <?php the_field('concept'); ?></p>
                
                </div>
            </div>

           
            <a href="<?php echo esc_url(home_url('/category/works/')); ?>"  class="btn">WorksList</a>
